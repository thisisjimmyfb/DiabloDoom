...
mobjinfo_t mobjinfo[NUMMOBJTYPES] = {
    ...
    {
		// MT_LOOT_NORMAL
	-1,		// doomednum (never placed on map; spawned at runtime)
	S_BON1,		// spawnstate (reuses stock sprite)
	1000,		// spawnhealth
	S_NULL,		// seestate
	sfx_None,		// seesound
	8,		// reactiontime
    ...
    },
    {
		// MT_LOOT_MAGIC
	-1,		// doomednum (never placed on map; spawned at runtime)
	S_BON2,		// spawnstate (reuses stock sprite)
	1000,		// spawnhealth
	S_NULL,		// seestate
	sfx_None,		// seesound
	8,		// reactiontime
    ...
    },
    {
		// MT_LOOT_RARE
	-1,		// doomednum (never placed on map; spawned at runtime)
	S_ARM1,		// spawnstate (reuses stock sprite)
	1000,		// spawnhealth
	S_NULL,		// seestate
	sfx_None,		// seesound
	8,		// reactiontime
    ...
    },
    {
		// MT_LOOT_SET
	-1,		// doomednum (never placed on map; spawned at runtime)
	S_ARM2,		// spawnstate (reuses stock sprite)
	1000,		// spawnhealth
	S_NULL,		// seestate
	sfx_None,		// seesound
	8,		// reactiontime
    ...
    },
    {
		// MT_LOOT_UNIQUE
	-1,		// doomednum (never placed on map; spawned at runtime)
	S_SOUL,		// spawnstate (reuses stock sprite)
	1000,		// spawnhealth
	S_NULL,		// seestate
	sfx_None,		// seesound
	8,		// reactiontime
